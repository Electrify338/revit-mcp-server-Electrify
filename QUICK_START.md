...
| 3 | **Revit MCP Plugin** (ZIP file) | [Download from GitHub Releases](https://github.com/Electrify338/revit-mcp-server-Electrify/releases) |
...
Go to the [Releases page](https://github.com/Electrify338/revit-mcp-server-Electrify/releases) and download the ZIP that matches your Revit version:
...
| Source code instead of release | You should see `.dll` files, NOT `.cs` files. Download the ZIP from [Releases](https://github.com/Electrify338/revit-mcp-server-Electrify/releases), not the source code |
